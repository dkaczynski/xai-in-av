...
The use cases defined in \ref{sec:UseCases} span users with a wide variety of backgrounds.
...
Apply XAI to \ref{sec:Alignment} and also identify \ref{sec:Challenges} that may be worked towards.
